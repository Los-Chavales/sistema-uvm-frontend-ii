...
} else if (props.typeMessage === "professor"){
  useStore = userStore();
} else if (props.typeMessage === "section"){
  ...
  <div class="container_modal">
    <div class="modalMessage">
      ...
      <div class="modalMessage_part" v-if="loginState">
        ...
        <ul class="modalMessage_p" v-if="getFormResult.listDetails.length > 0"
          v-for="(detail, i) in getFormResult.listDetails" :key="i">
          <li>{{ detail }}</li>
        </ul>
      </div>
